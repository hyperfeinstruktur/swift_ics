...
scatter_coeff = 0.1
burnin = 100
## nb of active particles = nwalkers x nsamples
## + same number of passive particles
N = nwalkers * nsamples

print('Generating ' + "{:d}".format(N) + ' particles...')
# Cut functions
r_inner = 8.0
r_outer = 90.0
n       = 4
...
# Sample DF
if use_parallel:
    with Pool(processes=6) as pool: #multiprocessing, remove you want to comput on a single core
